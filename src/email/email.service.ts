...
export class EmailService {
  ...
  private buildHtml(input: {
    ...
    const codeBlock = input.code ? `<tr style="margin:0;padding:0"><td style="margin:0;padding:0 0 34px"><table width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="background-color:#F5F1E6;border:1px solid #D4A72C;border-radius:14px"><tbody><tr><td align="center" style="padding:22px 16px;font-family:ui-monospace,Menlo,Consolas,'Courier New',monospace;font-size:20px;font-weight:700;letter-spacing:0.08em;color:#0B1F3A;-webkit-user-select:all;user-select:all">${escapeHtml(input.code)}</td></tr></tbody></table></td></tr>` : "";
